  ...
  return (
    <div className="w-full pt-6 px-3 mx-auto my-10 relative">
      ...
      <div className="hidden md:block absolute top-0 left-8 w-[300px] lg:w-[450px] p-8 lg:p-14 bg-white bg-opacity-70 text-[#3A3A3A]">
        <h1 className="text-3xl lg:text-5xl leading-[40px] lg:leading-[60px] font-bold">
          High-Quality Furniture Just For You
        </h1>
        <p className="mt-4 text-lg mb-4">
          Our furniture is carefully selected and made from the best quality
          materials suitable for your dream home.
        </p>
        <button className="mt-6 w-full px-4 py-4 lg:py-6 bg-[#E89F71] text-white font-semibold">
          Shop Now
        </button>
      </div>
    </div>
