...
const ProductList = () => {
    ...
    const handleLessProducts = () => {
        setVisibleProducts(prev => Math.max(prev - 8, 8)); // Ensure we don't go below the initial value
    };

    return (
        <div className="w-full max-w-7xl mx-auto py-6 px-3">
            <h2 className='pb-8 text-3xl text-center text-gray-800 font-semibold'>Our Products</h2>
